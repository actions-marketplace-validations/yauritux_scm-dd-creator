...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const main_1 = __importDefault(__nccwpck_require__(4225));
(0, main_1.default)();
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.loadAndBuildDashboard = exports.convertYmlToJson = void 0;
const core_1 = __nccwpck_require__(7733);
const axios_1 = __importDefault(__nccwpck_require__(8147));
const yaml = __importStar(__nccwpck_require__(6459));
const fs = __importStar(__nccwpck_require__(7147));
const path = __importStar(__nccwpck_require__(1017));
const ddUrl = (0, core_1.getInput)('dd-base-url');
 ...
 */
const isDashboardExist = async (title) => {
    const dashboards = await axios_1.default.get(`${ddUrl}/api/v1/dashboard`, {
        'headers': {
    ...
    const foundDashboard = dashboards.data.dashboards.filter((d) => d.title === title);
    if (foundDashboard && foundDashboard.length != 0) {
        return true;
    }
};
const convertYmlToJson = (file) => {
    if (file) {
...
exports.convertYmlToJson = convertYmlToJson;
const loadAndBuildDashboard = async (dashboardInfo, codeMetricNames, file) => {
    let jsonPayload = (0, exports.convertYmlToJson)(file);
    ...
    const response = await axios_1.default.post(`${ddUrl}/api/v1/dashboard`, jsonPayload, {
        'headers': {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
            'Content-Encoding': 'identity',
    ...
    (0, core_1.setOutput)('status', response.status);
    (0, core_1.setOutput)('data', response.data);
};
exports.loadAndBuildDashboard = loadAndBuildDashboard;
const bootstrap = async () => {
    try {
        const title = (0, core_1.getInput)('dashboard-title');
        const author = (0, core_1.getInput)('dashboard-author');
        const sonarBaseUrl = (0, core_1.getInput)('sonar-base-url');
        const componentName = (0, core_1.getInput)('component-name');
        ...
        await (0, exports.loadAndBuildDashboard)({ title, author, sonarBaseUrl, componentName }, { coverage, smells, vulnerabilities, securityHotspots, dupLinesDensity });
    }
    catch (error) {
